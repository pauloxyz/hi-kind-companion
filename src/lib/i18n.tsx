...
const dict: Dict = {
  ...
  comecar: { pt: "Começar aqui", en: "Start here", es: "Empezar aquí" },
  ...
  media: { pt: "Mídia de Trabalho", en: "Work Media", es: "Medios de Trabajo" },
  ...
  jobs: { pt: "Vagas", en: "Jobs", es: "Empleos" },
  ...
  visa: { pt: "Checklist do Visto", en: "Visa Checklist", es: "Checklist de Visa" },
  logout: { pt: "Sair", en: "Sign out", es: "Salir" },
  login: { pt: "Entrar", en: "Sign in", es: "Entrar" },
  email: { pt: "E-mail", en: "Email", es: "Correo" },
  password: { pt: "Senha", en: "Password", es: "Contraseña" },
  quality_score: { pt: "Score de Qualidade da Candidatura", en: "Application Quality Score", es: "Puntuación de Calidad" },
  strategy_banner: {
    ...
    es: "Rapidez + Volumen + Claridad + Confiabilidad aumentan tu tasa de respuesta. Postúlate a empleos nuevos cada día, con prueba visual de tu trabajo.",
  },
  fraud_banner: {
    ...
    es: "Nunca pagues para conseguir un empleo H-2A. Es ilegal y es señal de fraude.",
  },
  ...
  apply: { pt: "Candidatar-se", en: "Apply", es: "Postularse" },
  mass_apply: { pt: "Aplicação em massa", en: "Bulk apply", es: "Postulación masiva" },
  refresh_jobs: { pt: "🔄 Buscar vagas agora", en: "🔄 Fetch jobs now", es: "🔄 Buscar empleos ahora" },
  backfill_jobs: { pt: "Backfill últimos 15 dias", en: "Backfill last 15 days", es: "Backfill últimos 15 días" },
};
